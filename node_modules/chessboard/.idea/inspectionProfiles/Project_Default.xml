<component name="InspectionProjectProfileManager">
  <profile version="1.0">
    ...
    <inspection_tool class="BadExceptionsProcessingInspection" enabled="true" level="WARNING" enabled_by_default="true" />
    <inspection_tool class="EmptyClassInspection" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    <inspection_tool class="ExceptionsAnnotatingAndHandlingInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="MoreThanThreeArgumentsInspection" enabled="false" level="WEAK WARNING" enabled_by_default="false" />
    <inspection_tool class="PdoApiUsageInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="PhpUndefinedVariableInspection" enabled="true" level="WARNING" enabled_by_default="true">
      <option name="ENABLE_IN_FILE_SCOPE" value="false" />
    </inspection_tool>
    <inspection_tool class="PhpUnhandledExceptionInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="PhpUsageOfSilenceOperatorInspection" enabled="true" level="INFORMATION" enabled_by_default="true" />
    ...
    <inspection_tool class="TypesCastingWithFunctionsInspection" enabled="false" level="ERROR" enabled_by_default="false" />
    <inspection_tool class="UnSafeIsSetOverArrayInspection" enabled="true" level="WARNING" enabled_by_default="true">
      <option name="SUGGEST_TO_USE_NULL_COMPARISON" value="false" />
    </inspection_tool>
